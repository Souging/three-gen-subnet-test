...
def read_config() -> bt.config:
    ...
    parser.add_argument(
        ...
        nargs="*",
        help="Minimal required stake to set weights.",
        default=[49,27,128,124,212,142,81,4,160],
    )
    ...
    parser.add_argument(
        ...
        default=["http://127.0.0.1:10000","http://127.0.0.1:10001","http://127.0.0.1:10002","http://127.0.0.1:10003","http://127.0.0.1:10004","http://127.0.0.1:10005"],
    )
